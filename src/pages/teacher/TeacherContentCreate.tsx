...
const TeacherContentCreate = () => {
  ...
  // Extract YouTube video ID and validate
  ...
  const isQuizComplete = questions.length >= 5 && questions.every(
                  ...
                  {isVideoComplete && (
                    ...
                    >
                      <div className="flex items-start gap-3">
                        ...
                        <div>
                          <p className="font-medium text-primary">Quiz must be added</p>
                          <p className="text-sm text-muted-foreground">
                            Video cannot be saved without a linked quiz. Proceed to create the quiz.
                          </p>
                        </div>
                      </div>
                    </motion.div>
                  ...
                  {questions.length < 5 && (
                    ...
                    >
                      <div className="flex items-start gap-3">
                        <AlertCircle className="h-5 w-5 text-amber-500 mt-0.5" />
                        <div>
                          <p className="font-medium text-amber-500">Minimum 5 questions required</p>
                          <p className="text-sm text-muted-foreground">
                            Add at least {5 - questions.length} more question(s) to complete the quiz
                          </p>
                        </div>
                      </div>
                    </motion.div>
                    ...
                    <Card className="border-green-500/30 bg-green-500/5">
                      <CardContent className="p-4">
                        <div className="flex items-center gap-3 mb-3">
                          ...
                          <div>
                            <p className="font-medium text-foreground">Video Added</p>
                    ...
                    <Card className="border-green-500/30 bg-green-500/5">
                      <CardContent className="p-4">
                        <div className="flex items-center gap-3 mb-3">
                          ...
                          <div>
                            <p className="font-medium text-foreground">Quiz Created</p>
                            <p className="text-xs text-muted-foreground">Ready</p>
                          </div>
                          <CheckCircle2 className="h-5 w-5 text-green-500 ml-auto" />
                        </div>
                        <p className="text-sm text-foreground">{questions.length} questions</p>
                      </CardContent>
                    </Card>
                  </div>
