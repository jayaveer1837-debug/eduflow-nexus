              ...
              <CardContent className="space-y-6">
                ...
                <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                  ...
                  <div className="space-y-2">
                    ...
                    <p className="text-xs text-muted-foreground">Minimum amount for instructor withdrawals</p>
                  </div>
                </div>
                ...
                <div className="p-4 bg-primary/5 border border-primary/20 rounded-xl">
                  <div className="flex items-center gap-3 mb-3">
                    ...
                    <Badge className="bg-emerald-500/15 text-emerald-700">Connected</Badge>
                  </div>
                  <p className="text-sm text-muted-foreground mb-3">
                    Your payment gateway is configured and processing payments.
                  </p>
                  <Button variant="outline" size="sm">Configure Gateway</Button>
                </div>
              </CardContent>
            </Card>
          </TabsContent>
