...
const mockUsers: User[] = [
  { id: "1", name: "John Smith", email: "john.smith@email.com", role: "student", status: "active", joinedAt: "2024-01-15", lastActive: "2 hours ago", coursesEnrolled: 5 },
  { id: "2", name: "Sarah Johnson", email: "sarah.j@email.com", role: "instructor", status: "active", joinedAt: "2023-08-20", lastActive: "1 hour ago", coursesTaught: 8 },
  { id: "3", name: "Mike Chen", email: "mike.chen@email.com", role: "student", status: "active", joinedAt: "2024-02-10", lastActive: "5 min ago", coursesEnrolled: 3 },
  { id: "4", name: "Emily Davis", email: "emily.d@email.com", role: "instructor", status: "active", joinedAt: "2023-06-15", lastActive: "30 min ago", coursesTaught: 12 },
  { id: "5", name: "Alex Wilson", email: "alex.w@email.com", role: "student", status: "inactive", joinedAt: "2024-03-01", lastActive: "2 weeks ago", coursesEnrolled: 1 },
  { id: "6", name: "Jessica Brown", email: "jess.brown@email.com", role: "student", status: "active", joinedAt: "2024-01-28", lastActive: "3 hours ago", coursesEnrolled: 7 },
  { id: "7", name: "David Lee", email: "david.lee@email.com", role: "instructor", status: "suspended", joinedAt: "2023-11-10", lastActive: "1 month ago", coursesTaught: 4 },
  { id: "8", name: "Amanda Taylor", email: "amanda.t@email.com", role: "student", status: "active", joinedAt: "2024-02-20", lastActive: "1 hour ago", coursesEnrolled: 4 },
  { id: "9", name: "Chris Martin", email: "chris.m@email.com", role: "admin", status: "active", joinedAt: "2023-01-01", lastActive: "Just now" },
  { id: "10", name: "Lisa Anderson", email: "lisa.a@email.com", role: "student", status: "active", joinedAt: "2024-03-05", lastActive: "4 hours ago", coursesEnrolled: 2 },
];
        ...
        <AlertDialog open={isDeleteDialogOpen} onOpenChange={setIsDeleteDialogOpen}>
          <AlertDialogContent>
            <AlertDialogHeader>
              ...
              <AlertDialogDescription>
                Are you sure you want to delete {deletingUser?.name}? This action cannot be undone and will remove all their data from the platform.
              </AlertDialogDescription>
            </AlertDialogHeader>
            <AlertDialogFooter>
