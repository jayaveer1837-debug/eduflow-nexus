            ...
            <CardContent>
              <div className="space-y-6">
                {[
                  ...
                  { label: "Platform Uptime", value: 99.9, target: 99.5, color: "bg-purple-500" },
                ].map((metric, index) => (
                  <motion.div
                    key={metric.label}
                    ...
                    <div className="flex items-center justify-between text-sm">
                      ...
                      <div className="flex items-center gap-2">
                        ...
                        {metric.value >= metric.target ? (
                          <Badge className="bg-emerald-500/15 text-emerald-700 text-xs">On Target</Badge>
                        ) : (
                          <Badge variant="outline" className="text-amber-600 text-xs">Below Target</Badge>
                        )}
                      </div>
                    </div>
