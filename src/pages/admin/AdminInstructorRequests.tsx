...
// Mock data for instructor requests
const mockRequests: InstructorRequest[] = [
  {
    ...
    message: "I have 10 years of experience teaching data structures and algorithms. I would love to share my knowledge with students on EduNexus.",
    status: "pending",
  ...
  },
  {
    ...
    message: "I specialize in embedded systems and IoT. Looking forward to creating comprehensive courses on these topics.",
    status: "pending",
  ...
  },
  {
    ...
    message: "I want to create engaging courses on calculus and linear algebra for undergraduate students.",
    status: "pending",
  ...
  },
  {
    ...
    message: "15 years of industry experience in full-stack development. Want to bridge the gap between academia and industry.",
    status: "approved",
  ...
  },
  {
    ...
    email: "a.foster@yale.edu",
    institution: "Yale University",
    department: "Physics",
    message: "Passionate about making physics accessible to everyone through interactive online courses.",
    status: "rejected",
...
export default function AdminInstructorRequests() {
  ...
  const [requests, setRequests] = useState<InstructorRequest[]>(mockRequests);
